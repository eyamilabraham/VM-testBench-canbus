...
public class ConexionArduino extends JFrame implements SerialPortEventListener {
	...
	private static final int TIME_OUT = 100; //tiempo de espera para establecer la conexion
	...
	Thread t;						//hilos para manejo de reloj y escucha de puerto serie
	Thread th;
	static int dato;
	...
	ArrayList<String> SerialList = new ArrayList<String>();			//Lista de puertos serie disponibles
	...
	private static JLabel avSat;
	private static JLabel distance;
	private static JLabel StateSat;
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					...
					DigitalClock reloj = new DigitalClock(543,281,90,24);
	...
	public ConexionArduino() throws IOException {
		...
		btnConnect.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				String portConect = (String) comboSerial.getSelectedItem();   //seleccion del puerto serie
		...
		lblTelemetry.setForeground(new Color(0, 128, 128));
		...
		lblBattery.setBounds(278, 1, 182, 24);
		lblBattery.setHorizontalAlignment(SwingConstants.CENTER);
		lblBattery.setForeground(new Color(0, 128, 128));
		...
		JButton btnMeasure = new JButton("START");
		btnMeasure.setBounds(436, 258, 80, 23);
		btnMeasure.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				if (!measure) {
					...
					measure = true;
					sendData("d");   // d para empezar a medir distancia recorrida
				}
				else
					if (measure) {
						btnMeasure.setText("START");
						measure=false;
						sendData ("D");  //D detener Medicion recorrido
		...
		labelDate_1.setBounds(436, 279, 96, 24);
		...
		lblLeftHub.setForeground(new Color(0, 128, 128));
		...
		lblRightHub.setForeground(new Color(0, 128, 128));
		...
		lblGps.setForeground(new Color(0, 128, 128));
		lblGps.setFont(new Font("Comfortaa", Font.BOLD, 16));
		lblGps.setBounds(426, 125, 104, 34);
		window.add(lblGps);
		...
		JLabel lblAltitude = new JLabel("ALT:");
		lblAltitude.setForeground(Color.WHITE);
		lblAltitude.setFont(new Font("Dialog", Font.BOLD, 16));
		lblAltitude.setBounds(436, 208, 51, 23);
		window.add(lblAltitude);

		JLabel lblSpeedKmh = new JLabel("Km/h:");
		lblSpeedKmh.setForeground(Color.WHITE);
		lblSpeedKmh.setFont(new Font("Dialog", Font.BOLD, 16));
		lblSpeedKmh.setBounds(436, 157, 61, 23);
		...
		lbldistance.setBounds(436, 233, 51, 23);
		...
		JLabel lblSatellite = new JLabel("SATS:");
		lblSatellite.setForeground(Color.WHITE);
		lblSatellite.setFont(new Font("Dialog", Font.BOLD, 16));
		lblSatellite.setBounds(436, 183, 58, 23);
		window.add(lblSatellite);
		...
		altitude.setForeground(new Color(0, 191, 255));
		altitude.setFont(new Font("Dialog", Font.BOLD, 15));
		altitude.setBounds(489, 208, 120, 21);
		window.add(altitude);
		...
		kmh.setBounds(489, 157, 120, 21);
		window.add(kmh);

		avSat = new JLabel("");
		avSat.setHorizontalAlignment(SwingConstants.CENTER);
		avSat.setVerticalAlignment(SwingConstants.BOTTOM);
		avSat.setForeground(new Color(0, 191, 255));
		avSat.setFont(new Font("Dialog", Font.BOLD, 15));
		avSat.setBounds(489, 183, 120, 21);
		window.add(avSat);
		...
		distance.setBounds(489, 233, 120, 21);
		window.add(distance);
		...
		StateSat = new JLabel("Searching Satellite");
		StateSat.setFont(new Font("Dialog", Font.BOLD, 10));
		StateSat.setHorizontalAlignment(SwingConstants.CENTER);
		StateSat.setForeground(Color.GREEN);
		StateSat.setBounds(507, 134, 145, 14);
		window.add(StateSat);
		...
		lblPort.setForeground(new Color(0, 128, 128));
		...
		separator_1_1.setBounds(422, 315, 227, 2);
		...
		btnOn.setBounds(659, 275, 117, 45);
		window.add(btnOn);
		
		newLog = new JCheckBox("New Log");
		newLog.setForeground(Color.WHITE);
		newLog.setBackground(Color.BLACK);
		newLog.setBounds(657, 325, 119, 23);
		window.add(newLog);
		
		recData = new JCheckBox("Rec Data");
		recData.setEnabled(false);
		recData.setBackground(Color.BLACK);
		recData.setForeground(Color.WHITE);
		recData.setBounds(657, 350, 113, 23);
		window.add(recData);
			...
			while (true){
				try{
					...
					case 0x6F: 
						...
						break;
						case 128: CanMsgMl = "THRTLE ERROR";
						break;
						}
					...
					case 0x4F: 
						...
						break;
						case 4:  CanMsgE2Ml = "HALL THRTLE ERR";
						break;
						case 8:  CanMsgE2Ml = "ANGLE SENS ERR";
						break;
						case 16:  CanMsgE2Ml = "NO ERROR";
						break;
						case 32:  CanMsgE2Ml = "NO ERROR";
						break;
						case 64:  CanMsgE2Ml = "M OVR TEMP";
						break;
						case 128: CanMsgE2Ml = "HALL GALV ERR";
						break;
						}
					...
					case 0x28:
						...
						break;
						case 128: CanMsgMr = "THRTLE ERROR";
						break;
						}
					...
					case 0x29: 
						...
						break;
						case 4:  CanMsgE2Mr = "HALL THRTLE ERR";
						break;
						case 8:  CanMsgE2Mr = "ANGLE SENS ERR";
						break;
						case 16:  CanMsgE2Mr = "NO ERROR";
						break;
						case 32:  CanMsgE2Mr = "NO ERROR";
						break;
						case 64:  CanMsgE2Mr = "M OVR TEMP";
						break;
						case 128: CanMsgE2Mr = "HALL GALV ERR";
						break;
						}
	...
	private static JCheckBox newLog;
	private static JCheckBox recData;
	private static JLabel reloj;
	...
	public static void createfile() throws IOException {
		...
		if (qs2kw.isSelected())
		{engineSelected = "QS-2KW";}
		else
			if (qs4kw.isSelected())
			{engineSelected = "QS-4KW";}
			else
				if (qs6kw.isSelected())
				{engineSelected = "QS-6KW";}
				else
					if (qs8kw.isSelected()) 
					{engineSelected = "QS-8KW";}
					else
						if (pe3kw.isSelected()) 
						{engineSelected = "PE-3KW";}
		...
		String Testdate = labelDate_1.getText();		

		String fileName = engineSelected +"_test.csv";
		
		Weight = weightCar.getText().toString();

		weightCar.setEditable(false);

		try {
			newLog.setForeground(Color.GREEN);
	...
	public static void CSV_Write(int tps, int kmh) {
		...
		try {
			System.out.println("writer append csv");
	  ...
	  writer.append(
					...
					tps + "," + kmh + "," + "" + "," + hora + ":" + minutos + ":" + segundos + "," + lblTEMP.getText() + "," + lblHUM.getText() + "," + lblATM_PRESS.getText() + "," +
					pitch.getText()+ "," + roll.getText() +
					'\n'
					);
	  recData.setForeground(Color.RED);
			//writer.close();
